        ...
        **kwargs,
        ...
        if self.stencil_config.validate_args:
            ...
            if async_context:
                ...
                async_context.schedule(self.stencil_object, *args, **kwargs, exec_info=None, origin=self.origin, domain=self.domain,
                    fast_analysis_info = (self._argument_names, self._field_origins, self.domain) )
            else:
