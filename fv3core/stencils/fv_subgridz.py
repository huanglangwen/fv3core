...
class FVSubgridZ:
    ...
    def __init__(self, namelist):
        ...
        self._tmp_u0 = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_v0 = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_w0 = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_gz = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_t0 = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_static_energy = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_total_energy = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_cvm = utils.make_storage_from_shape(shape, is_temp=True)
        self._tmp_cpm = utils.make_storage_from_shape(shape, is_temp=True)
