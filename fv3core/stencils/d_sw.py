...
class DGridShallowWaterLagrangianDynamics:
    ...
    def __init__(self, namelist, column_namelist):
        ...
        shape_k = (1, 1, self.grid.npz)
        origin = self.grid.compute_origin()

        self.hydrostatic = namelist.hydrostatic
        self._tmp_heat_s = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_ub = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_vb = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_ke = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_vort = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_ut = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_vt = utils.make_storage_from_shape(shape, origin, is_temp=True)
        ...
        self._tmp_gx = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_gy = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_dw = utils.make_storage_from_shape(shape, origin, is_temp=True)
        self._tmp_wk = utils.make_storage_from_shape(shape, origin, is_temp=True)
        ...
        self._tmp_damp_3d = utils.make_storage_from_shape(shape_k, is_temp=True)
        self._tmp_dampterm = utils.make_storage_from_shape(shape, origin, is_temp=True)
